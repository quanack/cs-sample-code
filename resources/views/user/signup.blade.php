    ...
    <div class="container m-auto max-w-lg mt-10">
        <div id="content">
            <div class="bg-white shadow rounded-xl p-6 m-8 border border-gray-300">
                ...
                <hr>
                <form action="/user/register" method="POST" class="mt-4">
                    @csrf
                    <div class="mb-6">
                    ...
                    <div>
                        <button
                            class="bg-blue-400 hover:bg-blue-600 text-white py-1 px-4 rounded-sm drop-shadow w-full">Register</button>
                    </div>
                </form>
            </div>
        </div>
